...
public class Queen : Chessman
{
    ...
    private List<Vector2Int> GetAvailableBishopMoves(ref Chessman[,] board, int width) {
        List<Vector2Int> result = new List<Vector2Int>();
        // North East
    ...
    private List<Vector2Int> GetAvailableRookMoves(ref Chessman[,] board, int width) {
        List<Vector2Int> result = new List<Vector2Int>();
        // Down
